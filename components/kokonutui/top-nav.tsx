  ...
  if (loading) {
    return (
      <nav className="px-3 sm:px-6 flex items-center justify-between bg-white dark:bg-[#0F0F12] border-b border-gray-200 dark:border-[#1F1F23] h-full">
        <div className="font-medium text-sm text-gray-500">Loading...</div>
      </nav>
    )
  }
          ...
          <>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="focus:outline-none">
                <Image
                  src={user?.avatarUrl || "https://ferf1mheo22r9ira.public.blob.vercel-storage.com/avatar-01-n0x8HFv8EUetf9z6ht0wScJKoTHqf8.png"}
                  alt="User avatar"
                  width={28}
                  height={28}
